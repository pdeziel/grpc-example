...
// testing to prevent actual TCP network requests. A simpler approach for testing is to
// just invoke the methods directly, however using a bufconn connection provides
